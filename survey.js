        ...
        rl.question("What's your favorite thing to eat for that meal? ", (answer5) => {
          ...
          rl.question("Which sport is your absolute favourite? ", (answer6) => {
            ...
            rl.question("What is your superpower? In a few words, tell us what you are amazing at! ", (answer7) => {
              ...
              console.log(`${answer1} loves listening to ${answer3} while ${answer2}, devouring ${answer5} for ${answer4}, prefers ${answer6} to any other sport and is amazing at ${answer7}.`);
